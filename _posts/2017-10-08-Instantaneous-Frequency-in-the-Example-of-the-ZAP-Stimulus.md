...
$$ f(t) &= f_0 + \frac{f_1 - f_0}{T} \cdot t $$ <div style="text-align: right"> (1) </div>  
...
$$ \frac{\delta \phi}{\delta t} = 2 \pi \cdot f(t) $$ <div style="text-align: right"> (2) </div>  
Insert (1) in (2):  
$$ \frac{\delta \phi}{\delta t} = 2 \pi \cdot f_0 + \frac{f_1 - f_0}{T} \cdot t $$ <div style="text-align: right"> (3) </div>  
Integrate:  
$$ \phi(t) = 2 \pi \int^t_0 f_0 + \frac{f_1 - f_0}{T} \cdot \tau \delta\tau $$  
$$ = 2 \pi [f_0 \tau + \frac{1}{2} \frac{f_1 - f_0}{T} \cdot \tau^2]^t_0 $$  
$$ = 2 \pi (f_0 \cdot t + \frac{1}{2} \frac{f_1 - f_0}{T} \cdot t^2) $$ <div style="text-align: right"> (4) </div>  
Thus, the formula for the ZAP stimulus is:  
$$ ZAP(t) = \sin(2 \pi (f_0 \cdot t + \frac{1}{2} \frac{f_1 - f_0}{T} \cdot t^2)) $$ <div style="text-align: right"> (5) </div>  
